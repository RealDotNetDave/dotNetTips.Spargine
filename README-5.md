...
## Projects
![Spargine Layout](docs/graphics/Spargine.5.svg)
...
### .NET 5
*  	**dotNetTips.Spargine:** Library for Windows
...
*   **dotNetTips.Spargine.Tester:** Library for creating dummy data for use in unit tests.
### Benchmark Tests
