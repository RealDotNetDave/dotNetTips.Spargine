...
M02_L00:
       ...
       lea       rcx,[rbx+8]
       call      CORINFO_HELP_ASSIGN_REF
       mov       rdx,offset dotNetTips.Spargine.Extensions.ObjectExtensions+<>c.<DisposeFields>b__7_0(System.Reflection.FieldInfo)
       mov       [rbx+18],rdx
       mov       rcx,2A3245EB780
       mov       rdx,rbx
       call      CORINFO_HELP_CHECKED_ASSIGN_REF
...
M01_L01:
       ...
       mov       rcx,rax
       mov       r11,7FF86F2904C0
       call      qword ptr [7FF86F6C04C0]
       mov       [rbp+0FF88],rax
M01_L02:
       mov       rcx,[rbp+0FF88]
       mov       r11,7FF86F2904C8
       call      qword ptr [7FF86F6C04C8]
       test      eax,eax
       je        near ptr M01_L07
       mov       rcx,[rbp+0FF88]
       mov       r11,7FF86F2904D0
       call      qword ptr [7FF86F6C04D0]
       mov       rdi,rax
       mov       ecx,r15d
       add       ecx,1
       jo        near ptr M01_L05
...
M01_L07:
       ...
       je        short M01_L08
       mov       rcx,rax
       mov       r11,7FF86F2904D8
       call      qword ptr [7FF86F6C04D8]
M01_L08:
       mov       rax,r14
       lea       rsp,[rbp+0FFC8]
       pop       rbx
...
M01_L01:
       ...
       call      CORINFO_HELP_CHKCASTINTERFACE
       mov       rcx,rax
       mov       r11,7FF86F2804C0
       call      qword ptr [7FF86F6B04C0]
       mov       [rbp+0FF88],rax
M01_L02:
       mov       rcx,[rbp+0FF88]
       mov       r11,7FF86F2804C8
       call      qword ptr [7FF86F6B04C8]
       test      eax,eax
       je        near ptr M01_L07
       mov       rcx,[rbp+0FF88]
       mov       r11,7FF86F2804D0
       call      qword ptr [M01_L14]
       mov       rdi,rax
       mov       ecx,r15d
       add       ecx,1
       jo        near ptr M01_L05
...
M01_L07:
       ...
       je        short M01_L08
       mov       rcx,rax
       mov       r11,7FF86F2804D8
       call      qword ptr [7FF86F6B04D8]
M01_L08:
       mov       rax,r14
       lea       rsp,[rbp+0FFC8]
       pop       rbx
...
M01_L02:
       ...
       je        near ptr M01_L07
       mov       rcx,[rbp+0FF88]
       mov       r11,7FF86F2A04D0
       call      qword ptr [7FF86F6D04D0]
       mov       rdi,rax
       mov       ecx,r15d
       add       ecx,1
       jo        near ptr M01_L05
...
M01_L07:
       ...
       je        short M01_L08
       mov       rcx,rax
       mov       r11,7FF86F2A04D8
       call      qword ptr [7FF86F6D04D8]
M01_L08:
       mov       rax,r14
       lea       rsp,[rbp+0FFC8]
       pop       rbx
...
M02_L00:
       ...
       lea       rdx,[rbp+0FFE8]
       mov       rcx,rax
       mov       r11,7FF86F2B04F8
       call      qword ptr [7FF86F6F04F8]
       jmp       short M02_L02
M02_L01:
       mov       rcx,rsi
       mov       r11,7FF86F2B04F0
       call      qword ptr [7FF86F6F04F0]
       nop
M02_L02:
       lea       rsp,[rbp+0FFF8]
       pop       rsi
