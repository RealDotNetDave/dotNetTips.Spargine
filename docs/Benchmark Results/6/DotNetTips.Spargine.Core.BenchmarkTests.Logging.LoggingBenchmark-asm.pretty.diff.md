## DotNetTips.Spargine.Core.BenchmarkTests.Logging.LoggingBenchmark-20220719-160250
**Diff for LogCriticalBenchmark method between:**
...
```
**Diff for LogDebugBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
```
**Diff for LogWarningBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
-; Total bytes of code 114
```
**Diff for ILoggerLogCriticalBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
```
**Diff for ILoggerLogDebugBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
+; Total bytes of code 248
```
**Diff for ILoggerLogErrorBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
+; Total bytes of code 248
```
**Diff for ILoggerLogInformationBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
+; Total bytes of code 248
```
**Diff for ILoggerLogTraceBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
+; Total bytes of code 248
```
**Diff for ILoggerLogWarningBenchmark method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
