...
M02_L05:
       ...
       je        short M02_L06
       mov       rcx,rax
       mov       r11,7FFE642805C0
       call      qword ptr [7FFE648405C0]
       nop
M02_L06:
       xor       ecx,ecx
       mov       rax,[rbp+0FFB0]
...
M02_L05:
       ...
       je        short M02_L06
       mov       rcx,rax
       mov       r11,7FFE64290608
       call      qword ptr [7FFE64840608]
       nop
M02_L06:
       xor       ecx,ecx
       mov       rax,[rbp+0FFB0]
...
M01_L05:
       ...
       mov       rcx,[rcx+20]
       cmp       [rcx],ecx
       call      qword ptr [M01_L09]
       mov       rdi,rax
       mov       rdx,[rbp+0FFC0]
       test      rdx,rdx
       je        short M01_L06
       mov       rcx,rdx
       mov       r11,7FFE642705D0
       call      qword ptr [7FFE648205D0]
       nop
M01_L06:
       mov       rcx,[rbp+0FFC8]
       mov       byte ptr [rcx+28],0
       mov       edx,1
       call      qword ptr [7FFE6481D038]
       mov       rcx,[rbp+0FFC8]
       call      System.GC.SuppressFinalize(System.Object)
       mov       rax,rdi
       add       rsp,50
