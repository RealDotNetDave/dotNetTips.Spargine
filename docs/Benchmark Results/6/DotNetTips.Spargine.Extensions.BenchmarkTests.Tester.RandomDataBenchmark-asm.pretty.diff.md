## DotNetTips.Spargine.Extensions.BenchmarkTests.Tester.RandomDataBenchmark-20220719-133553
**Diff for CreatePerson01 method between:**
...
```
**Diff for CreatePerson04 method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
...
+; Total bytes of code 1181
```
**Diff for CreatePerson05 method between:**
.NET 6.0.7 (6.0.722.32202), X64 RyuJIT
.NET 7.0.0 (7.0.22.32404), X64 RyuJIT
```diff
