...
namespace dotNetTips.Spargine.Core
{
    ...
    public static class App
    {
        ...
        {
            Encapsulation.TryValidateParam<ArgumentNullException>(string.IsNullOrEmpty(cultureName) == false, nameof(cultureName));
        ...
        public static void KillProcess(string processName)
        {
            Encapsulation.TryValidateParam<ArgumentNullException>(
                string.IsNullOrEmpty(processName) == false, "Process name is required.");
