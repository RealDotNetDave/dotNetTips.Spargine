...
namespace dotNetTips.Spargine.Core.Xml
{
	/// <summary>
	...
	public static class XmlHelper
	{
		...
		[Information(nameof(DeserializeFromXmlFile), BenchMarkStatus = BenchMarkStatus.None, UnitTestCoverage = 100, Status = Status.Available)]
		...
		/// <param name="obj">The obj.</param>
		/// <param name="fileName">Name of the file.</param>
		[Information(nameof(SerializeToXmlFile), BenchMarkStatus = BenchMarkStatus.None, UnitTestCoverage = 100, Status = Status.Available)]
