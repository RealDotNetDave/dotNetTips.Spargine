...
namespace dotNetTips.Spargine.Extensions
{
	...
	public static class ObservableCollectionExtensions
	{
		...
		public static bool DoesNotHaveItems<T>(this ObservableCollection<T> list) => list?.FastCount() <= 0;
		...
		public static bool HasItems<T>(this ObservableCollection<T> source) => source?.FastCount() > 0;
		...
		[Information(nameof(HasItems), "David McCarter", "11/21/2020", BenchMarkStatus = 0, UnitTestCoverage = 100, Status = Status.Available)]
		public static bool HasItems<T>(this ObservableCollection<T> source, int count) => source?.FastCount() == count;
	}
}
