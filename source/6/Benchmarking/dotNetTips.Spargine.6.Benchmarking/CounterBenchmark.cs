...
namespace DotNetTips.Spargine.Benchmarking
{
	...
	public abstract class CounterBenchmark : Benchmark
	{
		...
		protected CounterBenchmark(in int maxCount)
		{
			this._maxCount = Math.Max(2, maxCount);

			ConsoleLogger.Default.WriteLine(LogKind.Info, $"Max Count={maxCount}:CounterBenchmark");
		}
		...
		public override void Setup()
		{
			...
			ConsoleLogger.Default.WriteLine(LogKind.Info, $"Max Count={this._maxCount}:{this.GetType().FullName}.");
		}
	}
}
