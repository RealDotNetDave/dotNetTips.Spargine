...
public class StringExtensionsTests
{
	...
	public void ContainsAnyTest()
	{
		...
		_ = Assert.ThrowsException<ArgumentNullException>(() => string.Empty.ContainsAny(StringComparison.InvariantCultureIgnoreCase, "Z", "W"));
	}
	...
	public void StartsWithOrdinalIgnoreCaseTest()
	{
		...
		_ = Assert.ThrowsException<ArgumentNullException>(() => _ = string.Empty.StartsWithOrdinalIgnoreCase("David"));
	}
