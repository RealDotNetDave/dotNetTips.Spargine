...
namespace DotNetTips.Spargine.Core
{
	...
	public static class ExecutionHelper
	{
		...
		public static int ProgressiveRetry([NotNull] Action operation, byte retryCount = 3, int retryWaitMilliseconds = 100)
		{
			...
			retryCount = retryCount.ArgumentInRange(paramName: nameof(retryCount), lower: 1, upper: byte.MaxValue);
			retryWaitMilliseconds = retryWaitMilliseconds.ArgumentInRange(paramName: nameof(retryWaitMilliseconds), lower: 1);
