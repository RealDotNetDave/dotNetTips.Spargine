...
namespace DotNetTips.Spargine.Core
{
	...
	[Information(nameof(Singleton<T>), author: "David McCarter", createdOn: "7/12/2021", UnitTestCoverage = 0, BenchMarkStatus = BenchMarkStatus.None, Status = Status.Available, Documentation = "ADD URL TO SEP ARTICLE")]
