...
namespace DotNetTips.Spargine.Tester.Models.RefTypes
{
	...
	public sealed record PersonRecord : IDataRecord, IComparable<PersonRecord>
	{
		...
		public string HomePhone
		{
			...
			init
			{
				this._homePhone = value.ArgumentNotNull().Length > 50 ? throw new ArgumentOutOfRangeException(nameof(this.HomePhone), "Home phone length is limited to 50 characters.") : value;
			}
		}
